...
var User = (_temp2 = _class = function (_BaseComponent) {
  ...
  function User() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = User.__proto__ || Object.getPrototypeOf(User)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["access_token", "mobile", "coupon_number", "nickname", "list"], _this.config = {
      navigationBarTitleText: "我的"
    }, _this.goPage = function (e) {
      if (e.currentTarget.dataset.url == "/pages/login/index" && _this.props.access_token) {
        return;
      }
      _taroWeapp2.default.navigateTo({
        url: e.currentTarget.dataset.url
      });
    }, _this.goToPage = function (e) {
      if (!_this.props.access_token) {
        _taroWeapp2.default.navigateTo({
  ...
  _createClass(User, [{
    ...
    value: function _createData() {
      ...
      var _props = this.__props,
          ...
          coupon_number = _props.coupon_number,
